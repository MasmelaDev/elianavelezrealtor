...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Properties", "description": "Available properties", "lang": "en" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "PublicLayout", $$PublicLayout, { "lang": "en", "t": t }, { "default": async ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="mx-auto max-w-7xl px-4 py-8"> <h1 class="text-2xl font-bold text-gray-900 mb-6">${t("properties.title")}</h1> ${renderComponent($$result3, "PropertyGrid", PropertyGrid, { "client:load": true, "initialProperties": list, "lang": "en", "initialZone": zone ?? "", "initialType": type ?? "", "client:component-hydration": "load", "client:component-path": "/home/miguel/dev/elianarealtor/src/components/properties/PropertyGrid", "client:component-export": "PropertyGrid" })} </div> ` })} ` })}`;
}, "/home/miguel/dev/elianarealtor/src/pages/en/properties/index.astro", void 0);

const $$file = "/home/miguel/dev/elianarealtor/src/pages/en/properties/index.astro";
const $$url = "/en/properties";
