...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'services.buy.title', label: 'Card 1 — Título', type: 'short' },
      { key: 'services.buy.desc', label: 'Card 1 — Descripción', type: 'long' },
      { key: 'services.sell.title', label: 'Card 2 — Título', type: 'short' },
      { key: 'services.sell.desc', label: 'Card 2 — Descripción', type: 'long' },
      { key: 'services.rent.title', label: 'Card 3 — Título', type: 'short' },
      { key: 'services.rent.desc', label: 'Card 3 — Descripción', type: 'long' },
      { key: 'image.service.buy', label: 'Card 1 — Foto (Opcional)', type: 'image' },
      { key: 'image.service.sell', label: 'Card 2 — Foto (Opcional)', type: 'image' },
      { key: 'image.service.rent', label: 'Card 3 — Foto (Opcional)', type: 'image' },
      {
        ...
        options: [
          ...
          { value: 'Sofa', label: 'Muebles / Interior' },
          { value: 'TreePine', label: 'Naturaleza / Exterior' },
          { value: 'Sun', label: 'Clima / Sol' },
          { value: 'ShieldCheck', label: 'Seguridad / Confianza' },
          { value: 'TrendingUp', label: 'Crecimiento / Inversión' },
          { value: 'Wallet', label: 'Billetera / Dinero' },
          { value: 'BadgeCheck', label: 'Certificado / Premium' },
          { value: 'Heart', label: 'Favorito / Amor' },
          { value: 'Briefcase', label: 'Negocios / Portafolio' },
          { value: 'Award', label: 'Premio / Logro' },
        ],
      },
      {
